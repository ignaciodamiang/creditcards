...
public void testDatabaseConnection() {
    ...
    try (InputStream input = DBConnectionTest.class.getClassLoader().getResourceAsStream("application.properties")) {
        props.load(input);
    } catch (IOException ex) {
        throw new RuntimeException("Error loading properties from application.properties file", ex);
    }
    ...
    try {
        ...
        // If the driver class is not found, throw an exception
        throw new RuntimeException("Error loading MySQL JDBC driver", ex);
